...
(function ($, window, undefined) {
    ...
    RoundSlider.prototype = {
        ...
        _bindMouseEvents: function (hook) {
            this[hook](this.control.parent(), "mousemove", this._handleMove);
            this[hook](this.control.parent(), "mouseup", this._handleUp);
            this[hook](this.control.parent(), "mouseleave", this._handleUp);

            // *** for Touch support *** //
            this[hook](this.control, "touchmove", this._handleMove);
            this[hook](this.control, "touchend", this._handleUp);
            this[hook](this.control, "touchcancel", this._handleUp);
        },
